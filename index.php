...
<head>
    ...
    <title>ChanRe Publisher</title>
    <link href="images/nopics.jpg" rel="icon">
...
<body>
            ...
            <div class="inner-wrapper">
                ...
                <nav class="side-nav w-100">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://chanrejournals.com/index.html">ChanRe Journals</a>
                        </li>
    ...
    <section id="home" class="p-0  single-slide">
        ...
        <div id="particles-text-morph">
            ...
            <h2 id="morph-text" class="pb-2">ChanRe Publisher</h2>
            <h3 class="font-light2"></h3>

            <a href="https://www.chanrejournals.com/index.html" class="btn btn-primary hover-default">ChanRe
                Journals</a>
            <a href="https://www.chanrebookshop.com/" class="btn btn-danger hover-default">ChanRe Book Shop</a>
        </div>
        <!--scroll down-->
        <div>
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 col-md-7 col-sm-7 text-sm-left text-center wow fadeInLeft" data-wow-delay="300ms">
                    <div class="heading-title mb-4">
                        <h2 class="darkcolor font-normal bottom30">ChanRe Healthcare <span
                                class="defaultcolor">Research</span> and Private Ltd</h2>
                    </div>
                    <p class="bottom35">ChanRe is a group started its operations in 2002 with an intention to establish
                        the healthcare and related research facilities in the field of rheumatology and immunology. The
                        company expanded its operations into research and publication in the year 2014 to facilitate the
                        knowledge dissemination. The company was founded by Dr. Chandrashekara S and Dr. Renuka
                        Panchagnula, eminent professionals in field of immunology rheumatology and pathology,
                        respectively. The company was further expanded by absorbing several professionals working in
                        diverse medical specialties. </p>
                    <!-- <a href="#our-team" class="button btnsecondary gradient-btn pagescroll mb-sm-0 mb-4">Learn More</a> -->
                </div>
                <div class="col-lg-5 offset-lg-1 col-md-5 col-sm-5 wow fadeInRight" data-wow-delay="300ms">
                    <!-- <div class="image"><img alt="SEO" src="img/1.JPG"></div> -->
                </div>
            </div>
        </div>
    </section>
    <section id="our-feature" class="single-feature padding">
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-6 col-md-7 col-sm-7 text-sm-left text-center wow fadeInLeft" data-wow-delay="300ms">
                    <div class="heading-title mb-4">
                        <h2 class="darkcolor font-normal bottom30">ChanRe<span class="defaultcolor"> Journals</span>
                        </h2>
                    </div>
                    <p class="bottom35">ChanRe Journals is the is the official journal publication division of ChanRe
                        Healthcare Ltd.. The key goal of the portal is to bring in academia, research, and publication
                        into a user-friendly platform. It functions as an ideal partner for publishing both internet-
                        and print-based journals in a comprehensive and timely manner. </p>
                    <!-- <a href="#our-team" class="button btnsecondary gradient-btn pagescroll mb-sm-0 mb-4">Learn More</a> -->
                </div>
                <div class="col-lg-5 offset-lg-1 col-md-5 col-sm-5 wow fadeInRight" data-wow-delay="300ms">
                    <div class="image"><img alt="SEO" src="img/2.JPG"></div>
                </div>
            </div>
        </div>
    </section>
    <section id="our-feature" class="single-feature padding">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 col-md-7 col-sm-7 text-sm-left text-center wow fadeInLeft" data-wow-delay="300ms">
                    <div class="heading-title mb-4">
                        <h2 class="darkcolor font-normal bottom30">Research<span class="defaultcolor"> Assist</span>
                        </h2>
                    </div>
                    <p class="bottom35">Nowadays it is highly challenging for the researchers to perform planning the
                        research work, documentation, writing, and performing the statistics, considering the time
                        needed for the core research work core and other add on activities. To ease such burden of
                        researchers, the company has expanded its operations to provide these services at an affordable
                        cost, as per the researchers’ requirement. Hence, the the division is aptly named as Research
                        Assist. The division serves as researcher’s ideal partner for developing protocols, statistics,
                        figures and illustrations, and assisting in carrying out all publishing-related activities in a
                        comprehensive and timely manner.
                        We assist you to create ready to print/use content accurately and skillfully. We undertake
                        publishing all kind of print and online materials including souvenirs, books, journals,
                        magazines, white papers, pamphlets, posters etc. Additionally, our team of skilled graphic
                        artists can handle all kind of artwork creations in any subject area. We provide high-quality
                        print and digital publishing solutions.
                    </p>
                    <!-- <a href="#our-team" class="button btnsecondary gradient-btn pagescroll mb-sm-0 mb-4">Learn More</a> -->
                </div>
                <div class="col-lg-5 offset-lg-1 col-md-5 col-sm-5 wow fadeInRight" data-wow-delay="300ms">
                    <div class="image"><img alt="SEO" src="img/3.JPG"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="our-feature" class="single-feature padding">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-12 col-md-12 col-sm-12 text-sm-left text-center wow fadeInLeft"
                    data-wow-delay="300ms">
                    <div class="heading-title mb-4">
                        <h2 class="darkcolor font-normal bottom30">Other<span class="defaultcolor"> activities</span>
                        </h2>
                    </div>
                    <p class="bottom35">We help pharmaceutical and medical device companies connect and engage with
                        doctors, nurses and other healthcare professionals through high-quality, independently published
                        content solutions and integrated media campaigns.
                    </p>
                    <p>As a leader in science and health, we publish peer-reviewed scientific, technical and medical
                        content. Our readers encompass healthcare professionals, researchers and scientists</p>
                    <p>We assist in tailoring advertisements and sponsorship solutions. We undertake digital and print
                        advertisments for medical reference books, congress coverage and reprints.</p>
                    <h4>Advertising</h4>
                    <p>
                        Connect with your target audience anywhere at any time via our multi-channel advertising and
                        sponsorship options through our print and digital platforms.
                    </p>
                    <!-- <a href="#our-team" class="button btnsecondary gradient-btn pagescroll mb-sm-0 mb-4">Learn More</a> -->
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center wow fadeIn animated" data-wow-delay="300ms">
                <p class="m-0 py-3">Copyright © <span id="year1"></span> <a href="javascript:void(0)" class="hover-default">ChanRe Publisher</a>. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</div> -->
